import { g as getRequestContext, a8 as __exportAll, a9 as isMissingTableError, aa as encodeCursor, u as validateIdentifier, ab as decodeCursor, ac as isPostgres, ad as currentTimestampValue } from './adapt-sandbox-entry_H5gl0boC.mjs';
...
async function loadVirtualModules() {
	if (virtualConfig === void 0) virtualConfig = (await import('./config_B3pgddBv.mjs')).default;
