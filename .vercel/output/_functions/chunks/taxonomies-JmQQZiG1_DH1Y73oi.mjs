import { a8 as __exportAll, al as chunks, am as SQL_BATCH_SIZE, a9 as isMissingTableError, k as requestCached, ao as peekRequestCache, g as getRequestContext, ae as isI18nEnabled, af as getFallbackChain, ap as setRequestCacheEntry, ag as getI18nConfig } from './adapt-sandbox-entry_H5gl0boC.mjs';
import { g as getDb } from './loader-ou_PXAjg_XDqWmGlU.mjs';
...
async function getEntriesByTerm(collection, taxonomyName, termSlug, options = {}) {
	const { getEmDashCollection } = await import('./query-yA3-rFji_DI0XfGdU.mjs').then((n) => n.o);
